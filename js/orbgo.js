...
var _zainhoda$orbgo$Orbgo$isNothing = function (maybe) {
	var _p0 = maybe;
	if (_p0.ctor === 'Just') {
		return false;
	} else {
...
var _zainhoda$orbgo$Orbgo$Measure = {ctor: 'Measure'};
var _zainhoda$orbgo$Orbgo$Column = {ctor: 'Column'};
var _zainhoda$orbgo$Orbgo$Row = {ctor: 'Row'};
var _zainhoda$orbgo$Orbgo$Category = {ctor: 'Category'};
var _zainhoda$orbgo$Orbgo$TimeDelta = {ctor: 'TimeDelta'};
var _zainhoda$orbgo$Orbgo$DateTime64 = {ctor: 'DateTime64'};
var _zainhoda$orbgo$Orbgo$Bool64 = {ctor: 'Bool64'};
...
var _zainhoda$orbgo$Orbgo$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'DataTypes':
				...
				if (_p2.ctor === 'Ok') {
					var lines = A2(
						...
						'lines',
						_elm_lang$core$String$lines(_p2._0));
					var fields = A2(
						_elm_lang$core$Debug$log,
						'fields',
						A2(
							...
							function (l) {
								return A2(
									...
									{ctor: '_Tuple2', _0: '', _1: _zainhoda$orbgo$Orbgo$Object},
									A2(
										_elm_lang$core$Maybe$map,
										function (fieldName) {
											return {ctor: '_Tuple2', _0: fieldName, _1: _zainhoda$orbgo$Orbgo$Object};
										},
										_elm_lang$core$List$head(
											_elm_lang$core$String$words(l))));
							},
							lines));
					return {
						ctor: '_Tuple2',
			...
			default:
				var _p5 = A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$updateSticky, _p1._0, model.dragDrop);
				var model_ = _p5._0;
				var result = _p5._1;
				var _p6 = function () {
					var _p7 = result;
					if (_p7.ctor === 'Nothing') {
						...
						return {ctor: '_Tuple2', _0: _p7._0._1, _1: _p7._0._0};
					}
				}();
				var x = _p6._0;
				var str = _p6._1;
...
var _zainhoda$orbgo$Orbgo$model = {
	availableFields: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'local_date', _1: _zainhoda$orbgo$Orbgo$Object},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'brand', _1: _zainhoda$orbgo$Orbgo$Object},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'dma', _1: _zainhoda$orbgo$Orbgo$Object},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'num_visits', _1: _zainhoda$orbgo$Orbgo$Float64},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'dwell_time', _1: _zainhoda$orbgo$Orbgo$Int64},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _zainhoda$orbgo$Orbgo$DataTypes = function (a) {
	return {ctor: 'DataTypes', _0: a};
};
var _zainhoda$orbgo$Orbgo$getAvailableFields = A2(
	_elm_lang$http$Http$send,
	_zainhoda$orbgo$Orbgo$DataTypes,
	_elm_lang$http$Http$getString('http://zainhoda.pythonanywhere.com/dtypes.to_string()'));
...
var _zainhoda$orbgo$Orbgo$viewDiv = F4(
	function (position, d, maybeDragId, dropId) {
		var highlight = A2(
			_elm_lang$core$Maybe$withDefault,
			false,
			A2(
		...
		var currentColumns = A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			A2(_eeue56$elm_all_dict$EveryDict$get, position, d));
		...
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				highlight,
				((!alreadyAtCurrentPosition) || _elm_lang$core$Native_Utils.eq(position, _zainhoda$orbgo$Orbgo$NoPosition)) ? A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$droppable, _zainhoda$orbgo$Orbgo$DragDropMsg, position) : {ctor: '[]'}),
			function () {
				var _p9 = _elm_lang$core$List$length(currentColumns);
				if (_p9 === 0) {
					return {
						ctor: '::',
					...
					return A2(
						...
						function (x) {
							return A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$draggable, _zainhoda$orbgo$Orbgo$DragDropMsg, x),
									{
										ctor: '::',
...
var _zainhoda$orbgo$Orbgo$view = function (model) {
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('top_icon_bar clearfix'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('icon_group'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$src('img/orbgo.svg'),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {ctor: '[]'}
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('fas fa-arrow-left fa-2x'),
												_1: {ctor: '[]'}
											},
											{ctor: '[]'}),
										_1: {ctor: '[]'}
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('fas fa-arrow-right fa-2x'),
													_1: {ctor: '[]'}
												},
												{ctor: '[]'}),
											_1: {ctor: '[]'}
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('fas fa-save fa-2x'),
														_1: {ctor: '[]'}
													},
													{ctor: '[]'}),
												_1: {ctor: '[]'}
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('fas fa-sync-alt fa-2x'),
															_1: {ctor: '[]'}
														},
														{ctor: '[]'}),
													_1: {ctor: '[]'}
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('fas fa-swatchbook fa-2x'),
													_1: {ctor: '[]'}
												},
												{ctor: '[]'}),
											_1: {ctor: '[]'}
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('fas fa-sort-amount-down fa-2x'),
														_1: {ctor: '[]'}
													},
													{ctor: '[]'}),
												_1: {ctor: '[]'}
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('fas fa-sort-amount-up fa-2x'),
															_1: {ctor: '[]'}
														},
														{ctor: '[]'}),
													_1: {ctor: '[]'}
							...
							_1: {
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value('Python Code'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Python Code'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$value('Output'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('icon_group no-border flt_rt'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('fas fa-bolt fa-2x'),
															_1: {ctor: '[]'}
														},
														{ctor: '[]'}),
													_1: {ctor: '[]'}
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('ui-tabs ui-corner-all ui-widget ui-widget-content'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('tabs'),
											_1: {ctor: '[]'}
										}
									},
									{
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-controls', 'tabs-1'),
														_1: {
															ctor: '::',
															_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-expanded', 'true'),
															_1: {
																ctor: '::',
																_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-labelledby', 'ui-id-1'),
																_1: {
																	ctor: '::',
																	_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-selected', 'true'),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('ui-tabs-tab ui-corner-top ui-state-default ui-tab ui-tabs-active ui-state-active'),
																		_1: {
																			ctor: '::',
													...
													},
													{
														...
														_0: A2(
															_elm_lang$html$Html$a,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$href('#tabs-1'),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$id('ui-id-1'),
																		_1: {
																			ctor: '::',
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-controls', 'tabs-2'),
															_1: {
																ctor: '::',
																_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-expanded', 'false'),
																_1: {
																	ctor: '::',
																	_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-labelledby', 'ui-id-2'),
																	_1: {
																		ctor: '::',
																		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-selected', 'false'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$class('ui-tabs-tab ui-corner-top ui-state-default ui-tab'),
																			_1: {
																				ctor: '::',
																				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'role', 'tab'),
																				_1: {
														...
														},
														{
															...
															_0: A2(
																_elm_lang$html$Html$a,
																{
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$href('#tabs-2'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$id('ui-id-2'),
																			_1: {
																				ctor: '::',
																				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'role', 'presentation'),
																				_1: {
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Analytics'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}),
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-hidden', 'false'),
													_1: {
														ctor: '::',
														_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-labelledby', 'ui-id-1'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('ui-tabs-panel ui-corner-bottom ui-widget-content'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$id('tabs-1'),
																_1: {
																	ctor: '::',
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('tabs_container_1'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$class('db_name'),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
															...
															_1: {
																...
																_0: A2(
																	...
																	},
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('heading_text'),
																				_1: {ctor: '[]'}
																			},
																			{
																				ctor: '::',
																					...
																					_0: A2(
																						...
																						{ctor: '[]'},
																						{
																							...
																							_0: A2(
																								...
																								{
																									ctor: '::',
																									_0: _elm_lang$html$Html_Attributes$class('fas fa-th-list'),
																									_1: {ctor: '[]'}
																								},
																								{ctor: '[]'}),
																							_1: {ctor: '[]'}
																...
																_1: {
																	ctor: '::',
																	_0: A4(_zainhoda$orbgo$Orbgo$viewDiv, _zainhoda$orbgo$Orbgo$NoPosition, model.fieldsPositioned, maybeDragId, dropId),
																	_1: {ctor: '[]'}
																}
															}
														}),
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('tabs_container_2'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Measures'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																				...
																				_0: A2(
																					...
																					{ctor: '[]'},
																					{
																						...
																						_0: A2(
																							...
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text('Visit Count'),
																								_1: {ctor: '[]'}
																							}),
																						_1: {ctor: '[]'}
																					}),
																						...
																						_0: A2(
																							...
																							{ctor: '[]'},
																							{
																								...
																								_0: A2(
																									...
																									{
																										ctor: '::',
																										_0: _elm_lang$html$Html$text('Measure Values'),
																										_1: {ctor: '[]'}
																									}),
																								_1: {ctor: '[]'}
																							}),
													...
													_elm_lang$html$Html$div,
													{
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$id('tabs-2'),
																	_1: {
																		ctor: '::',
																		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'role', 'tabpanel'),
																		_1: {
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('content_box'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											...
											_1: {
												ctor: '::',
												_0: A4(_zainhoda$orbgo$Orbgo$viewDiv, _zainhoda$orbgo$Orbgo$Images, model.fieldsPositioned, maybeDragId, dropId),
												_1: {ctor: '[]'}
											}
										}),
									_1: {
										...
										_0: A2(
											...
											},
											{
												...
												_1: {
													ctor: '::',
													_0: A4(_zainhoda$orbgo$Orbgo$viewDiv, _zainhoda$orbgo$Orbgo$Filters, model.fieldsPositioned, maybeDragId, dropId),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: A2(
												...
												},
												{
													...
													_1: {
														...
														_0: A2(
															...
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$name('marks'),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$value('Automatic'),
																				_1: {ctor: '[]'}
																			},
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Automatic'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$value('Option 2'),
																					_1: {ctor: '[]'}
																				},
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text('Option 2'),
																					_1: {ctor: '[]'}
																				}),
																			_1: {
																				ctor: '::',
																				_0: A2(
																					...
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$value('Option 3'),
																						_1: {ctor: '[]'}
																					},
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html$text('Option 3'),
																						_1: {ctor: '[]'}
																					}),
																				_1: {ctor: '[]'}
																			}
														...
														_1: {
															ctor: '::',
															_0: A4(_zainhoda$orbgo$Orbgo$viewDiv, _zainhoda$orbgo$Orbgo$Measure, model.fieldsPositioned, maybeDragId, dropId),
															_1: {ctor: '[]'}
														}
													}
												}),
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('col3_top_bar columns'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('left_portion'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Columns'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}),
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('right_portion'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: A4(_zainhoda$orbgo$Orbgo$viewDiv, _zainhoda$orbgo$Orbgo$Column, model.fieldsPositioned, maybeDragId, dropId),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('col3_top_bar rows'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: A4(_zainhoda$orbgo$Orbgo$viewDiv, _zainhoda$orbgo$Orbgo$Row, model.fieldsPositioned, maybeDragId, dropId),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('col3_contentarea'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('footer1'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Data Source'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Sheet 1'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$src('images/footer1.jpg'),
															_1: {ctor: '[]'}
														},
														{ctor: '[]'}),
													_1: {ctor: '[]'}
												...
												_0: A2(
													...
													{ctor: '[]'},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$src('images/footer2.jpg'),
																_1: {ctor: '[]'}
															},
															{ctor: '[]'}),
														_1: {ctor: '[]'}
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$src('images/footer3.jpg'),
																	_1: {ctor: '[]'}
																},
																{ctor: '[]'}),
															_1: {ctor: '[]'}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('footer2'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('footer_icons_group'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													{ctor: '[]'},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$src('images/footer8.jpg'),
																_1: {ctor: '[]'}
															},
															{ctor: '[]'}),
														_1: {ctor: '[]'}
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$src('images/footer9.jpg'),
																	_1: {ctor: '[]'}
																},
																{ctor: '[]'}),
															_1: {ctor: '[]'}
														...
														_0: A2(
															...
															{ctor: '[]'},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$src('images/footer10.jpg'),
																		_1: {ctor: '[]'}
																	},
																	{ctor: '[]'}),
																_1: {ctor: '[]'}
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$src('images/footer4.jpg'),
																	_1: {ctor: '[]'}
																},
																{ctor: '[]'}),
															_1: {ctor: '[]'}
														...
														_0: A2(
															...
															{ctor: '[]'},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$src('images/footer5.jpg'),
																		_1: {ctor: '[]'}
																	},
																	{ctor: '[]'}),
																_1: {ctor: '[]'}
															...
															_0: A2(
																...
																{ctor: '[]'},
																{
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$src('images/footer6.jpg'),
																			_1: {ctor: '[]'}
																		},
																		{ctor: '[]'}),
																	_1: {ctor: '[]'}
																...
																_0: A2(
																	...
																	{ctor: '[]'},
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$src('images/footer7.jpg'),
																				_1: {ctor: '[]'}
																			},
																			{ctor: '[]'}),
																		_1: {ctor: '[]'}
...
var _zainhoda$orbgo$Orbgo$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				_zainhoda$orbgo$Orbgo$model,
				{
					fieldsPositioned: A3(
						_eeue56$elm_all_dict$EveryDict$insert,
						_zainhoda$orbgo$Orbgo$NoPosition,
			...
			_1: _zainhoda$orbgo$Orbgo$getAvailableFields
		},
		update: _zainhoda$orbgo$Orbgo$update,
		view: _zainhoda$orbgo$Orbgo$view,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['Orbgo'] = Elm['Orbgo'] || {};
if (typeof _zainhoda$orbgo$Orbgo$main !== 'undefined') {
    _zainhoda$orbgo$Orbgo$main(Elm['Orbgo'], 'Orbgo', undefined);
}
